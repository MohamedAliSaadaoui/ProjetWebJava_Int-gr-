 ...
 */
final class Version20250304195523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande (id INT AUTO_INCREMENT NOT NULL, organisation_id INT DEFAULT NULL, description VARCHAR(255) NOT NULL, localisation VARCHAR(100) NOT NULL, categorie VARCHAR(50) NOT NULL, statut VARCHAR(50) DEFAULT \'En cours\' NOT NULL, INDEX IDX_2694D7A59E6B1585 (organisation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
