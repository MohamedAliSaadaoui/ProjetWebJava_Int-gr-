...
class BlogController extends AbstractController
{
    ...
    public function index(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        $orderBy = $request->query->get('orderBy', 'ASC'); // Par défaut, tri ascendant
        ...
        // Récupérer les articles paginés et filtrés
        $articles = $repositoryArticle->searchforum($searchTerm, $orderBy);
    ...
    public function statisticsAction(
        ...
        $forumsByDate = $ArticleRepository->countByDate();
        ...
        $forumsByMonth = $ArticleRepository->countByMonth();
        ...
        return $this->render('blog/statistics.html.twig', [
